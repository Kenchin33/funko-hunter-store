...
PRODUCTS = [
    {
        "name": "Funko Pop! Pop! Rides Orochimaru with Manda 143",
        "slug": "funko-pop-orochimaru-with-manda-143",
        "category": "anime",
        "subcategory": "naruto",
        "series": "Naruto",
        "product_number": "143",
        "short_description": "Фігурка Orochimaru with Manda із серії Naruto.",
        "rarity": "regular",
        "is_new": False,
        "is_active": True,
        "images": [
            "https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dw3950abce/images/funko/upload/1/90623_NarutoClassic_S2_OrochimaruManda_POP_RIDES_GLAM-1-WEB.png?sw=800&sh=800",
            "https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dwcf69aadf/images/funko/upload/1/90623_NarutoClassic_S2_OrochimaruManda_POP_RIDES_GLAM-WEB.png?sw=800&sh=800",
        ],
        "aliases": [
            "Орочімару",
            "Наруто",
        ...
        "variants": [
            #{
            #   "slug": "funko-pop-lucy-hoodie-2416",
            ...
            #},
            {
                "slug": "funko-pop-orochimaru-with-manda-143-damaged-box",
               "variant_name": "Пошкоджена коробка",
               "price": Decimal("1500.00"),
               "compare_at_price": Decimal("1650.00"),
