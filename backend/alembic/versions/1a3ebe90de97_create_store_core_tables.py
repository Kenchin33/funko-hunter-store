"""create store core tables

Revision ID: 1a3ebe90de97
Revises: 
Create Date: 2026-04-17 14:38:02.808344
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_products_availability_status'), 'products', ['availability_status'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_products_availability_status'), table_name='products')
